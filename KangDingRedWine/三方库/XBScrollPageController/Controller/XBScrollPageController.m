...
- (void)viewDidLayoutSubviews
{
    ...
    self.pageCollectionView.frame = CGRectMake(0, self.tagViewHeight + self.yFloat , XBScreenWidth, kSCREEN_HEIGHT - self.tagViewHeight - self.yFloat - self.bottomDistance);
